...
gulp.task('styles', function () {
  return gulp.src('source/sass/arena-styles.scss')
    .pipe(cssglob({
      extensions: ['.scss']
    }))
      .pipe(plumber({
...
gulp.task('sass-lint', function () {
  return gulp.src([
    ...
    '!source/sass/arena-styles.scss',
    '!source/sass/components/_arena-styles.scss',
    '!source/sass/components/_jetpack.scss',
    '!source/sass/components/_genericons.scss',
    '!source/sass/components/_navigation.scss',
    '!source/sass/components/_flexslider.scss'
  ])
    .pipe(sassLint({
      options: {
        formatter: 'stylish',
...
gulp.task('browser-sync', function () {
  ...
  browserSync.init(files, {
    proxy: "local.arena.govspace.gov.au",
    notify: true
  });
});
