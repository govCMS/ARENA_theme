  ...
  <div id="innerContainer">
    ...
    <div id="sideWrapper">
      <div id="sidebar">
        <div class="inner">
          ...
          <?php if (!empty($page['sidebar_first'])): ?>
            <div class="secondLevel">
              ...
              <div id="navMeasurer">
                <a href="javascript:void(0)" id="mobileCloseNav"><span
                    class="arrow"></span> Back</a>
                <aside role="complementary">
        ...
        <a href="javascript:void(0)" title="" id="mobileNavOpener"><span class="arrow"></span><span class="text">Explore more in About ARENA</span></a>
      </div>
    </div>
